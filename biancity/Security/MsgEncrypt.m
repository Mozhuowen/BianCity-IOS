...
//    NSMutableData * codeMsg = [[NSMutableData alloc] initWithData:[time dataUsingEncoding:NSUTF8StringEncoding]];
//   // NSLog(@"time is %@",codeMsg);
//    [codeMsg appendData:msg];
    
    char keyPtr[kCCKeySizeAES256];
    bzero(keyPtr, sizeof(keyPtr));
    memccpy(keyPtr, [akey bytes], 0, sizeof(akey));
//   NSString * strKey =[[NSString alloc ] initWithData:akey encoding:NSUTF8StringEncoding];
